    ...
    <div class="container">
      <div class="inner-container">
        ...
        <div class="text-with-button">
          <div class="buttons">
            <a class="button button-with-hover button-with-black-background-hover button-with-icon" href="#" title="{str_homepage_our_friends_meet_them_all_text}">
              ...
              <span class="button-label">{str_homepage_our_friends_meet_them_all_text} TODO</span>
            </a>
          </div>
        </div>
      </div>

...
var App = {
  ...
  customerSupportLoadForm: function customerSupportLoadForm() {
    var customerSupportButtonLoadForm = document.querySelector('#customer-support-product-partner .load-form');
    var customerSupportForm = document.querySelector('#customer-support-product-contact-form');
